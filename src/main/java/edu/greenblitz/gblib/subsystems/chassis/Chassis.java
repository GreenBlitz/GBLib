package edu.greenblitz.GBLib.src.main.java.edu.greenblitz.gblib.subsystems.chassis;
...
/** not tested, if you ever do tank drive, test!**/
public class Chassis extends GBSubsystem {
	...
	private Chassis(IMotorFactory motorFactory, int[] ports, boolean[] isInverted, double wheelDistance) {
		...
		gyroscope = new PigeonGyro(0); //Pigeon connects to talon/CAN bus
		gyroscope.resetYawAngle(0);
